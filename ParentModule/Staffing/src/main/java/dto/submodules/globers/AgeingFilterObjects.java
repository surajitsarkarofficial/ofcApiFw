...
public class AgeingFilterObjects {
	 ...
	 * @param availability
	 */
	public AgeingFilterObjects(ArrayList<String> availability) {
		super();
	 ...
	 * @param handler
	 */
	public AgeingFilterObjects(Handlers handler) {
		super();
	 ...
	 */
	public AgeingFilterObjects(String globerId, String email, String location, String studio, Handlers handler,
			String position, String seniority, String benchStartDate, ArrayList<String> availability) {
		super();
		this.globerId = globerId;
		this.email = email;
		this.location = location;
	...
	/**
	 * @param ageing the ageing to set
	 */
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + (int) (ageing ^ (ageing >>> 32));
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AgeingFilterObjects other = (AgeingFilterObjects) obj;
		if (ageing != other.ageing)
			return false;
	...
	public String toString() {
		return "AgeingFilterObjects [globerId=" + globerId + ", email=" + email + ", location=" + location + ", studio="
				+ studio + ", handler=" + handler + ", position=" + position + ", availability=" + availability
				+ ", seniority=" + seniority + ", benchStartDate=" + benchStartDate + ", ageing=" + ageing + "]";
	}

	/**
	 * @param candidateId
	 */
	public AgeingFilterObjects(String candidateId) {
		super();
