 ...
 *
 */
public class DeleteCecoTestHelper extends ManageTestHelper {

	public DeleteCecoTestHelper(String userName) throws Exception {
		super(userName);
	}

	/**
	 * This method will perform a DELETE in order to delete a ceco.
	 * @param parameters
	 * @return response 
	 */
	public Response deleteCeco(DeleteCecoParameters parameters) {
		String requestURL = ManageBaseTest.baseUrl + String.format(ApproverManagementEndpoints.deleteCeco, parameters.getCecoNumber());
