...
public class Item extends PurchasesPayLoadHelper {
    ...
    /**
     * This method will return a new item.
     * This item is going to be used by PostQuotationPayLoadHelper constructor.
     * @author german.massello 
     * @throws Exception 
     */
    public Item(String userName, String groupName, String countryName, String projectId) throws Exception {
    	this.supplyId = new MaterialTestHelper(userName).getRandomMaterial(groupName, countryName).getId();
    	this.deliveryPlaceId = new StoreTestHelper(userName).getRandomStore(countryName).getId().toString();
    	this.quantity = "1";
    	this.expectedDeliveryDate = todayInMs;
    	this.technicalSpecifications = "technicalSpecifications N:"+todayInMs;
